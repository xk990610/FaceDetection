package com.sky.facedetectiontrackerdemo.adapter;
...
public class ListViewAdapter extends SimpleAdapter {
    public String TAG = "ListViewAdapter";
    private int[] appTo;
    ...
    public ListViewAdapter(Context context,
        ...
        Log.v(TAG, "ListViewAdapter");
    }

    public View getView(int position, View convertView, ViewGroup parent) {
        View v;
        if (convertView == null) {
            v = appInflater.inflate(appResource, parent, false);
            final int[] to = appTo;
            ...
            if (v != null) {
                ...
                if (!bound) {
                    ...
                    if (v instanceof TextView) {
                      ...
                      ((ImageView) v).setImageResource((int)data);
                    } else {
